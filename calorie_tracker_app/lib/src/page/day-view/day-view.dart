    ...
    return Scaffold(
        ...
        body: StreamProvider<List<FoodTrackTask>>.value(
          ...
          value: new DatabaseService(
                  uid: "fir-auth-b7d90", currentDate: DateTime.now())
              .foodTracks,
...
class FoodTrackList extends StatelessWidget {
  ...
  Future<void> loadFromMockDatabase() async {
    databaseService =
        new DatabaseService(uid: "fir-auth-b7d90", currentDate: DateTime.now());
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
            ...
            iconSize: 16,
            onPressed: () async {
              databaseService.updateFoodTrackEntry(foodTrackEntry);
